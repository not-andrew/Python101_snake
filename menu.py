...
def display_menu_window(screen, resolution):
	...
	image_resolution = (resolution[0] / 2, resolution[1] / 1.5)
	...
	button_pos = []
	button_pos.append(((resolution[0] - button_resolution[0]) / 2, image_resolution[1] + 50))
	button_pos.append(((resolution[0] - button_resolution[0]) / 2, image_resolution[1] + 120))
	...
	screen.blit(text_quit, (button_pos[1][0] + 50, button_pos[1][1]))
